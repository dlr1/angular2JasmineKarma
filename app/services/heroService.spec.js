    ...
    return {
        ...
        execute: function() {
            testing_1.describe('HeroService', function () {
                var service;
                var mockbackend;
                testing_1.beforeEachProviders(function () { return [core_1.provide(heroService_1.HeroService, { useClass: heroService_1.MockHeroService }),
                ...
                testing_1.it('getHeroes synch should return 10', testing_1.inject([heroService_1.HeroService], function (testService) {
                ...
                testing_1.it('getSomeData mockbackend', function () {
                    var response = ["ru", "es"];
                    ...
                    service.getSomeData().subscribe(function (x) {
                        testing_1.expect(x.length).toEqual(10);
                    });
                });
            });
        }
